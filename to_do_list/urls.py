...
urlpatterns = [
    ...
    path("tag/create", views.TagCreateView.as_view(), name="task-create-view"),
    path("tag/<int:pk>/update", views.TagUpdateView.as_view(), name="task-update-view"),
    path("tag/<int:pk>/delete", views.TagDeleteView.as_view(), name="task-delete-view"),
